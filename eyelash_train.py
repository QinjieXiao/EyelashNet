...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default=CONFIG.root_path + 'config/train_eyelash_tencent38+render91_dataset.toml')
    #parser.add_argument('--config', type=str, default='/home/xqj/zhangzr/GCA-Matting-master/config/train_eyelash_whitepadding.toml')
    parser.add_argument('--local_rank', type=int, default=0)

    # Parse configuration
    args = parser.parse_args()
    #configfile='/home/xqj/zhangzr/GCA-Matting-master/config/train_eyelash_pair.toml'
    #phase='train'
    #local_rank=0
